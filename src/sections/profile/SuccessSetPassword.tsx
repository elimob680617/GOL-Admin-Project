...
import successfully from 'src/assets/images/SuccessForgetPassword.png';

// import { PATH_AUTH } from 'src/routes/paths';
import ResetPassFormStyleCompenent from './FormStyleComponent';
...
export default function SuccessResetPassword() {
  return (
    <ResetPassFormStyleCompenent title="Success Reset Password">
      <ContentStyle>
        <img loading="lazy" src={successfully} alt="success" />
